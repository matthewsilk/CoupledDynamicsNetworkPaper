...
#Code for Figure S1
par(mfrow=c(5,5),mar=c(2.5,2.5,2.5,2.5))
...
for(i in socs){
  for(j in infs){
    if(j!=0&i!=1){
      par(mar=c(0,0,0,0))
      plot(dat_high$sev[p2[dat_high$ParameterID,8]==i&p2[dat_high$ParameterID,10]==j]~dat_high$EpStartInf[p2[dat_high$ParameterID,8]==i&p2[dat_high$ParameterID,10]==j],col=adjustcolor(he_pal[dat_high$he_col[p2[dat_high$ParameterID,8]==i&p2[dat_high$ParameterID,10]==j]],0.4),pch=16,xlim=c(0,300),ylim=c(0,1),yaxt="n",xaxt="n",las=2)
    }
    if(j==0&i==1){
      par(mar=c(2.5,2.5,0,0))
      plot(dat_high$sev[p2[dat_high$ParameterID,8]==i&p2[dat_high$ParameterID,10]==j]~dat_high$EpStartInf[p2[dat_high$ParameterID,8]==i&p2[dat_high$ParameterID,10]==j],col=adjustcolor(he_pal[dat_high$he_col[p2[dat_high$ParameterID,8]==i&p2[dat_high$ParameterID,10]==j]],0.4),pch=16,xlim=c(0,300),ylim=c(0,1),las=2)
    }
    if(j!=0&i==1){
      par(mar=c(2.5,0,0,0))
      plot(dat_high$sev[p2[dat_high$ParameterID,8]==i&p2[dat_high$ParameterID,10]==j]~dat_high$EpStartInf[p2[dat_high$ParameterID,8]==i&p2[dat_high$ParameterID,10]==j],col=adjustcolor(he_pal[dat_high$he_col[p2[dat_high$ParameterID,8]==i&p2[dat_high$ParameterID,10]==j]],0.4),pch=16,xlim=c(0,300),ylim=c(0,1),yaxt="n",las=2)
    }
    if(j==0&i!=1){
      par(mar=c(0,2.5,0,0))
      plot(dat_high$sev[p2[dat_high$ParameterID,8]==i&p2[dat_high$ParameterID,10]==j]~dat_high$EpStartInf[p2[dat_high$ParameterID,8]==i&p2[dat_high$ParameterID,10]==j],col=adjustcolor(he_pal[dat_high$he_col[p2[dat_high$ParameterID,8]==i&p2[dat_high$ParameterID,10]==j]],0.4),pch=16,xlim=c(0,300),ylim=c(0,1),xaxt="n",las=2)
    }
  }
}
...
for(i in socs){
  for(j in infs){
    if(j!=0&i!=1){
      par(mar=c(0,0,0,0))
      plot(dat_high$sev[p2[dat_high$ParameterID,8]==i&p2[dat_high$ParameterID,10]==j]~dat_high$MinConc[p2[dat_high$ParameterID,8]==i&p2[dat_high$ParameterID,10]==j],col=adjustcolor(he_pal[dat_high$he_col[p2[dat_high$ParameterID,8]==i&p2[dat_high$ParameterID,10]==j]],0.4),pch=16,xlim=c(0,1),ylim=c(0,1),yaxt="n",xaxt="n",las=2)
    }
    if(j==0&i==1){
      par(mar=c(2.5,2.5,0,0))
      plot(dat_high$sev[p2[dat_high$ParameterID,8]==i&p2[dat_high$ParameterID,10]==j]~dat_high$MinConc[p2[dat_high$ParameterID,8]==i&p2[dat_high$ParameterID,10]==j],col=adjustcolor(he_pal[dat_high$he_col[p2[dat_high$ParameterID,8]==i&p2[dat_high$ParameterID,10]==j]],0.4),pch=16,xlim=c(0,1),ylim=c(0,1),las=2)
    }
    if(i==1&j!=0){
      par(mar=c(2.5,0,0,0))
      plot(dat_high$sev[p2[dat_high$ParameterID,8]==i&p2[dat_high$ParameterID,10]==j]~dat_high$MinConc[p2[dat_high$ParameterID,8]==i&p2[dat_high$ParameterID,10]==j],col=adjustcolor(he_pal[dat_high$he_col[p2[dat_high$ParameterID,8]==i&p2[dat_high$ParameterID,10]==j]],0.4),pch=16,xlim=c(0,1),ylim=c(0,1),yaxt="n",las=2)
    }
    if(j==0&i!=1){
      par(mar=c(0,2.5,0,0))
      plot(dat_high$sev[p2[dat_high$ParameterID,8]==i&p2[dat_high$ParameterID,10]==j]~dat_high$MinConc[p2[dat_high$ParameterID,8]==i&p2[dat_high$ParameterID,10]==j],col=adjustcolor(he_pal[dat_high$he_col[p2[dat_high$ParameterID,8]==i&p2[dat_high$ParameterID,10]==j]],0.4),pch=16,xlim=c(0,1),ylim=c(0,1),xaxt="n",las=2)
    }
  }
}
...
for(i in 1:nrow(inf_res[[609]])){
  lines(inf_res[[609]][i,],col=col10[i],lwd=3)
}

plot(NULL,xlim=c(0,150),ylim=c(0,1),xlab="Days",ylab="Proportion concerned",cex.lab=1.6,cex.axis=1.3,las=1)
for(i in 1:nrow(inf_res[[609]])){
  lines(conc_res[[609]][i,],col=col10[i],lwd=3)
}

mtext(paste0("Reassurance effect is ",round(he[[609]],3)),side=1,adj=0.95,line=-1.5,cex=1.2)
...
dat_high$EpidemicStartTime<-dat_high$EpidemicStartTime1-40
...
dat_mid$EpidemicStartTime<-dat_mid$EpidemicStartTime1-40
...
set.seed(3)
q1<-sample(which(dat_high$sev<0.1),1)
q2<-sample(which(dat_high$sev>0.1&dat_high$sev<0.2),1)
q3<-sample(which(dat_high$sev>0.2&dat_high$sev<0.3),1)
q4<-sample(which(dat_high$sev>0.3&dat_high$sev<0.4),1)
q5<-sample(which(dat_high$sev>0.4&dat_high$sev<0.5),1)
q6<-sample(which(dat_high$sev>0.5&dat_high$sev<0.6),1)
q7<-sample(which(dat_high$sev>0.6&dat_high$sev<0.7),1)
q8<-sample(which(dat_high$sev>0.7&dat_high$sev<0.8),1)
q9<-sample(which(dat_high$sev>0.8),1)
...
for(i in 1:5){
  y_t<-inf_res[[which(he2==dat_high$he[qs[[i]]])]][dat_high$Community[qs[[i]]],]
  lines(x=seq(1,length(y_t),1),y=y_t,lwd=5,col=line_pal[round(dat_high$sev[qs[[i]]]*40)])
}

mtext("Number Infected",side=2,line=3.5,cex=1.5)

points(x=rep(165,40),y=seq(50,75,length.out=40),col=line_pal,cex=3,pch=15)
text("Severity = 1",x=175,y=75,adj=c(0,0.5),cex=1.2)
text("Severity = 0.5",x=175,y=62.5,adj=c(0,0.5),cex=1.2)
text("Severity = 0",x=175,y=50,adj=c(0,0.5),cex=1.2)
